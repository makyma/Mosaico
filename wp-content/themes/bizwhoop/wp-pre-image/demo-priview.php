 ...
 * @return bool
 */
function bizwhoop_pre_demo() {
	$ti_theme = wp_get_theme();
	$theme_name = $ti_theme ->get( 'TextDomain' );
	$active_theme = bizwhoop_get_raw_option( 'template' );
	return apply_filters( 'bizwhoop_pre_demo', ( $active_theme != strtolower( $theme_name ) && ! is_child_theme() ) );
}
 ...
 * @return bool|mixed
 */
function bizwhoop_get_raw_option( $opt_name ) {
