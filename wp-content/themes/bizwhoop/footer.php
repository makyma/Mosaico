    ...
    <div class="overlay">
      ...
      <div class="bizwhoop-footer-copyright">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
			<p>&copy; <?php echo esc_html(date('Y')).' '; bloginfo( 'name' ); ?> | <?php printf( esc_html__( 'Theme by %1$s', 'bizwhoop' ),  '<a href="'.esc_url('https://www.themeansar.com').'" rel="designer">Theme Ansar</a>' ); ?></p>
			</div>
